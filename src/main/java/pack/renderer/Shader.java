        ...
        try {
            ...
            for (String line : lines) {
                if (line.startsWith("#type")) {
                    ...
                    } else if (currentType.equals("fragment")) {
                        fragmentShader.append(line).append("\n");
                    }
                }
            }

            this.vertexSource = vertexShader.toString();
            this.fragmentSource = fragmentShader.toString();

            if (vertexSource.isEmpty() || fragmentSource.isEmpty()) {
                throw new IOException("Shader source is incomplete: " + filepath);
            }
        } catch (IOException e) {
            e.printStackTrace();
...
//            throw new IOException("Shader file not found:  V 1" + filepath);
//            }
...
//            throw new RuntimeException(type + " SHADER COMPILATION ERROR: " + log);
//        }
//    }
//
...
//            String log = glGetProgramInfoLog(shaderProgramID, len);
//            throw new RuntimeException("SHADER LINKING ERROR: " + log);
//        }
//    }
